...
namespace ProtoBuf
{
        ...
        class BclHelpers
    {
        ...
        /// <exception cref="NotSupportedException">If the  does not support constructor-skipping</exception>
        public static object GetUninitializedObject(Type type)
        {
#if PLAT_BINARYFORMATTER && !(WINRT || PHONE8)
            return System.Runtime.Serialization.FormatterServices.GetUninitializedObject(type);
#else
            throw new NotSupportedException("Constructor-skipping is not supported on this ");
#endif
        }
#if FX11
