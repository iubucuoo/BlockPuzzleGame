...
namespace ProtoBuf
{
    ...
    public sealed class ProtoContractAttribute : Attribute
    {
        ...
        /// care to increase the  for new elements, otherwise data corruption
        /// may occur.
        /// </summary>
        ...
        /// <summary>
        /// Specifies an offset to apply to [DataMember(=...)] markers;
        /// this is useful when working with mex-generated classes that have
        /// a different origin (usually 1 vs 0) than the original data-contract.
        /// 
        /// This value is added to the  of each member.
        /// </summary>
